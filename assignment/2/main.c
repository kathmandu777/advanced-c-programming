...
int main(void)
{
    ...
    for (int i = 0; i < row; i++)
    {
        for (int j = 0; j < column; j++)
        {
            ...
            {
                // TODO: 自分自身の値を後から引いているが、条件判定で自分自身は元からsumに入れないほうがスマートかも
                sum -= input[i][j];
                output[i][j] = sum / 8;
            }
            else
...
-------------------------------
0| 83 86 77 15 93 35 86 92
1| 49 61 45 57 43 64 57 26
2| 40 52 35 51 50 52 38 29
3| 82 53 47 59 48 50 38  2
4| 22 48 44 54 48 56 40 42
5| 29 37 49 58 58 71 47 24
6| 15 70 13 26 91 80 56 73
